async function openIntegrations() {
    ...
    contentArea.innerHTML = `
        <div class="integrations-grid" style="margin-top: 20px; display: flex; gap: 20px; padding-left: 20px;">
