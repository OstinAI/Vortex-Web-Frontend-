...
// Глобальные переменные для управления полями
let isManagementMode = false;   // ТОЛЬКО ОДНО ОБЪЯВЛЕНИЕ!
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    // ЭТИ ФУНКЦИИ ТЕПЕРЬ В CardInfoFields.js
    loadCustomFields();      // <-- функция из CardInfoFields.js
    checkPermissions();      // <-- функция из CardInfoFields.js
...
async function addManualPayment() {
    ...
    try {
        ...
        // ✅ ВАЖНО: СОХРАНЯЕМ В SALE STATE!
        await saveTransactionToCRM();
